...
inline void sha512_runtime_routine(std::uint_least64_t* __restrict state,std::byte const* __restrict blocks_start,std::byte const* __restrict blocks_last) noexcept
{
	...
	simd_vector<std::uint_least64_t,2> s1;
	...
	{
		sha512_simd16_byte_swap_message_2rounds(s0,s1,blocks_start,w,0);
		s2=s0;
		sha512_simd16_byte_swap_message_2rounds(s0,s1,blocks_start,w,2);
		std::uint_least64_t bpc{b^c};
		sha512_scalar_round(s2[0],a,b,d,e,f,g,h,bpc);
		sha512_scalar_round(s2[1],h,a,c,d,e,f,g,bpc);
		s2=s0;
		sha512_simd16_byte_swap_message_2rounds(s0,s1,blocks_start,w,4);
		sha512_scalar_round(s2[0],g,h,b,c,d,e,f,bpc);
		sha512_scalar_round(s2[1],f,g,a,b,c,d,e,bpc);
		s2=s0;
		sha512_simd16_byte_swap_message_2rounds(s0,s1,blocks_start,w,6);
		sha512_scalar_round(s2[0],e,f,h,a,b,c,d,bpc);
		sha512_scalar_round(s2[1],d,e,g,h,a,b,c,bpc);
		s2=s0;
		sha512_simd16_byte_swap_message_2rounds(s0,s1,blocks_start,w,8);
		sha512_scalar_round(s2[0],c,d,f,g,h,a,b,bpc);
		sha512_scalar_round(s2[1],b,c,e,f,g,h,a,bpc);
		s2=s0;
		sha512_simd16_byte_swap_message_2rounds(s0,s1,blocks_start,w,10);
		sha512_scalar_round(s2[0],a,b,d,e,f,g,h,bpc);
		sha512_scalar_round(s2[1],h,a,c,d,e,f,g,bpc);
		s2=s0;
		sha512_simd16_byte_swap_message_2rounds(s0,s1,blocks_start,w,12);
		sha512_scalar_round(s2[0],g,h,b,c,d,e,f,bpc);
		sha512_scalar_round(s2[1],f,g,a,b,c,d,e,bpc);
		s2=s0;
		sha512_simd16_byte_swap_message_2rounds(s0,s1,blocks_start,w,14);
		sha512_scalar_round(s2[0],e,f,h,a,b,c,d,bpc);
		sha512_scalar_round(s2[1],d,e,g,h,a,b,c,bpc);
		s2=s0;
		for(std::uint_fast8_t i{16};i!=80;i+=8)
		{
			sha512_simd16_compute_message_2rounds(s0,s1,w,i);
			sha512_scalar_round(s2[0],c,d,f,g,h,a,b,bpc);
			sha512_scalar_round(s2[1],b,c,e,f,g,h,a,bpc);
			s2=s0;
			sha512_simd16_compute_message_2rounds(s0,s1,w,i+2);
			sha512_scalar_round(s2[0],a,b,d,e,f,g,h,bpc);
			sha512_scalar_round(s2[1],h,a,c,d,e,f,g,bpc);
			s2=s0;
			sha512_simd16_compute_message_2rounds(s0,s1,w,i+4);
			sha512_scalar_round(s2[0],g,h,b,c,d,e,f,bpc);
			sha512_scalar_round(s2[1],f,g,a,b,c,d,e,bpc);
			s2=s0;
			sha512_simd16_compute_message_2rounds(s0,s1,w,i+6);
			sha512_scalar_round(s2[0],e,f,h,a,b,c,d,bpc);
			sha512_scalar_round(s2[1],d,e,g,h,a,b,c,bpc);
			s2=s0;
#if 0
			sha512_simd16_compute_message_2rounds(s0,s1,w,i+8);
			sha512_scalar_round(s2[0],c,d,f,g,h,a,b,bpc);
			sha512_scalar_round(s2[1],b,c,e,f,g,h,a,bpc);
			s2=s0;
			sha512_simd16_compute_message_2rounds(s0,s1,w,i+10);
			sha512_scalar_round(s2[0],a,b,d,e,f,g,h,bpc);
			sha512_scalar_round(s2[1],h,a,c,d,e,f,g,bpc);
			s2=s0;
			sha512_simd16_compute_message_2rounds(s0,s1,w,i+12);
			sha512_scalar_round(s2[0],g,h,b,c,d,e,f,bpc);
			sha512_scalar_round(s2[1],f,g,a,b,c,d,e,bpc);
			s2=s0;
			sha512_simd16_compute_message_2rounds(s0,s1,w,i+14);
			sha512_scalar_round(s2[0],e,f,h,a,b,c,d,bpc);
			sha512_scalar_round(s2[1],d,e,g,h,a,b,c,bpc);
			s2=s0;
#endif
