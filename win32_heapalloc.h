...
inline void *win32_heapalloc_handle_common_impl(void *heaphandle, ::std::size_t n, ::std::uint_least32_t flag) noexcept
{
	...
	if constexpr(::fast_io::asan::asan_status::enabled==::fast_io::asan::asan_status::native)
	{
		::fast_io::asan::__asan_poison_memory_region(p, n);
	}
	return p;
}
...
inline void *win32_heaprealloc_handle_common_impl(void *heaphandle, void *addr, ::std::size_t n, ::std::uint_least32_t flag) noexcept
{
	...
	if constexpr(::fast_io::asan::asan_status::enabled==::fast_io::asan::asan_status::native)
	{
		::fast_io::asan::__asan_unpoison_memory_region(addr, ::fast_io::win32::HeapSize(heaphandle, 0, addr));
	}
...
inline ::fast_io::allocation_least_result win32_heapalloc_least_common_impl(::std::size_t n, ::std::uint_least32_t flag) noexcept
{
	...
	::std::size_t hpsize{::fast_io::win32::HeapSize(processheap, 0, ptr)};
	if constexpr(::fast_io::asan::asan_status::enabled==::fast_io::asan::asan_status::native)
	{
		::fast_io::asan::__asan_poison_memory_region(ptr, hpsize);
	}
	return {ptr, hpsize};
}
...
public:
	...
	static inline void deallocate(void *addr) noexcept
	{
		...
		void* heaphandle{::fast_io::win32::GetProcessHeap()};
		if constexpr(::fast_io::asan::asan_status::enabled==::fast_io::asan::asan_status::native)
		{
			::fast_io::asan::__asan_unpoison_memory_region(addr, ::fast_io::win32::HeapSize(heaphandle, 0, addr));
		}
		::fast_io::win32::HeapFree(heaphandle, 0u, addr);
	}
#if 0
