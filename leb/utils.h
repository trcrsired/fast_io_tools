...
template<my_integral T,std::size_t pow>
inline constexpr T compile_pow2{compile_time_pow(std::remove_cvref_t<T>(2),pow)};

template<my_integral T,std::size_t pow>
inline constexpr T compile_pow2_m1{static_cast<T>(compile_pow2<T,pow>-static_cast<T>(1))};
