...
inline constexpr bool char_digit_to_literal(my_make_unsigned_t<char_type>& ch) noexcept
{
	...
	else if constexpr(base==16)
	{
		switch(ch)
		{
		case char_literal_v<u8'0',char_type>:
		{
			ch=0;
			return false;
		}
		case char_literal_v<u8'1',char_type>:
		{
			ch=1;
			return false;
		}
		case char_literal_v<u8'2',char_type>:
		{
			ch=2;
			return false;
		}
		case char_literal_v<u8'3',char_type>:
		{
			ch=3;
			return false;
		}
		case char_literal_v<u8'4',char_type>:
		{
			ch=4;
			return false;
		}
		case char_literal_v<u8'5',char_type>:
		{
			ch=5;
			return false;
		}
		case char_literal_v<u8'6',char_type>:
		{
			ch=6;
			return false;
		}
		case char_literal_v<u8'7',char_type>:
		{
			ch=7;
			return false;
		}
		case char_literal_v<u8'8',char_type>:
		{
			ch=8;
			return false;
		}
		case char_literal_v<u8'9',char_type>:
		{
			ch=9;
			return false;
		}
		case char_literal_v<u8'A',char_type>:case char_literal_v<u8'a',char_type>:
		{
			ch=10;
			return false;
		}
		case char_literal_v<u8'B',char_type>:case char_literal_v<u8'b',char_type>:
		{
			ch=11;
			return false;
		}
		case char_literal_v<u8'C',char_type>:case char_literal_v<u8'c',char_type>:
		{
			ch=12;
			return false;
		}
		case char_literal_v<u8'D',char_type>:case char_literal_v<u8'd',char_type>:
		{
			ch=13;
			return false;
		}
		case char_literal_v<u8'E',char_type>:case char_literal_v<u8'e',char_type>:
		{
			ch=14;
			return false;
		}
		case char_literal_v<u8'F',char_type>:case char_literal_v<u8'f',char_type>:
		{
			ch=15;
			return false;
		}
...
inline constexpr bool char_is_digit(my_make_unsigned_t<char_type> ch) noexcept
{
	...
	else if constexpr(base==16)
	{
		switch(ch)
		{
		case char_literal_v<u8'0',char_type>:case char_literal_v<u8'1',char_type>:
		case char_literal_v<u8'2',char_type>:case char_literal_v<u8'3',char_type>:
		case char_literal_v<u8'4',char_type>:case char_literal_v<u8'5',char_type>:
		case char_literal_v<u8'6',char_type>:case char_literal_v<u8'7',char_type>:
		case char_literal_v<u8'8',char_type>:case char_literal_v<u8'9',char_type>:
		case char_literal_v<u8'A',char_type>:case char_literal_v<u8'B',char_type>:
		case char_literal_v<u8'C',char_type>:case char_literal_v<u8'D',char_type>:
		case char_literal_v<u8'E',char_type>:case char_literal_v<u8'F',char_type>:
		case char_literal_v<u8'a',char_type>:case char_literal_v<u8'b',char_type>:
		case char_literal_v<u8'c',char_type>:case char_literal_v<u8'd',char_type>:
		case char_literal_v<u8'e',char_type>:case char_literal_v<u8'f',char_type>:
		{
