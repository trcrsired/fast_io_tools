...
enum class scan_flags:std::uint_least32_t
{
none=0,
allow_plus_sign=static_cast<std::uint_least32_t>(static_cast<std::uint_least32_t>(1u)<<static_cast<std::uint_least32_t>(0u)),
exact=static_cast<std::uint_least32_t>(static_cast<std::uint_least32_t>(1u)<<static_cast<std::uint_least32_t>(1u)),
skip_all_none_domain_characters=static_cast<std::uint_least32_t>(static_cast<std::uint_least32_t>(1u)<<static_cast<std::uint_least32_t>(2u)),
ignore_seperator=static_cast<std::uint_least32_t>(static_cast<std::uint_least32_t>(1u)<<static_cast<std::uint_least32_t>(3u)),
noskipws=static_cast<std::uint_least32_t>(static_cast<std::uint_least32_t>(1u)<<static_cast<std::uint_least32_t>(4u)),
prefix=static_cast<std::uint_least32_t>(static_cast<std::uint_least32_t>(1u)<<static_cast<std::uint_least32_t>(5u)),
skip_zero=static_cast<std::uint_least32_t>(static_cast<std::uint_least32_t>(1u)<<static_cast<std::uint_least32_t>(6u)),
uppercase=static_cast<std::uint_least32_t>(static_cast<std::uint_least32_t>(1u)<<static_cast<std::uint_least32_t>(7u))
};

constexpr scan_flags operator&(scan_flags x, scan_flags y) noexcept
{
using utype = typename std::underlying_type<scan_flags>::type;
return static_cast<scan_flags>(static_cast<utype>(x) & static_cast<utype>(y));
}
...
constexpr scan_flags operator~(scan_flags x) noexcept
{
using utype = typename std::underlying_type<scan_flags>::type;
return static_cast<scan_flags>(~static_cast<utype>(x));
}

inline constexpr scan_flags& operator&=(scan_flags& x, scan_flags y) noexcept{return x=x&y;}
