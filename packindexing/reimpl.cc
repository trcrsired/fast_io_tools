...
constexpr void print_controls_impl(T outsm, Args... args) {
    ...
    constexpr bool has_obuffer_ops{::fast_io::operations::decay::defines::has_obuffer_basic_operations<T>};
    ...
    // Case 2: Arguments are provided in the pack
        ...
        if constexpr ((::fast_io::scatter_printable<chtype, Args> && ...)) {
            ...
            // If there are multiple arguments or a newline is required
                ...
                constexpr ::std::size_t n{sizeof...(Args) + static_cast<::std::size_t>(line)}; // Calculate the total number of scatters
                ::fast_io::basic_io_scatter_t<chtype> scatters[n]; // Allocate the scatter array
                ...
                ::fast_io::operations::decay::scatter_write_all_decay(outsm, scatters, n);
            }
        }
        ...
        // Scenario 2: Reserve-printable arguments
            ...
            constexpr ::std::size_t total_buffer_size{
                ...
                static_cast<::std::size_t>(line) // Include space for the newline if needed
            };
            ...
            if constexpr (has_obuffer_ops) {
                ...
                constexpr ::std::ptrdiff_t diff_buffer_size{static_cast<::std::ptrdiff_t>(total_buffer_size)};
            ...
            [&]<::std::size_t... I>(::std::index_sequence<I...>) {
                (
                    (current_ptr = print_reserve_define(
                        ::fast_io::io_reserve_type<chtype, Args>, current_ptr, args...[I]
                    )), ...
                );
            }(::std::make_index_sequence<sizeof...(Args)>{});
