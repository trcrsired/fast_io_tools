...
#pragma comment(linker,"/alternatename:__imp_?_wgetenv_s@win32@fast_io@@YAHPAIPA_SIPB_S@Z=__imp___wgetenv_s")
#pragma comment(linker,"/alternatename:?_wgetenv_s@win32@fast_io@@YAHPAIPA_SIPB_S@Z=__wgetenv_s")
