...
#pragma comment(linker,"/alternatename:__imp_?RtlSecureZeroMemory@win32@fast_io@@YGPAXPIAXI@Z=__imp__RtlSecureZeroMemory@8")
...
#pragma comment(linker,"/alternatename:__imp_?GetUserDefaultLocaleName@win32@fast_io@@YGHPA_WH@Z=__imp__GetUserDefaultLocaleName@")
...
#pragma comment(linker,"/alternatename:__imp_?NtWriteFile@nt@win32@fast_io@@YGIPAX0P6AX0PAUio_status_block@123@I@Z01PBXIPA_JPAI@Z=__imp__NtWriteFile@36")
#pragma comment(linker,"/alternatename:__imp_?ZwWriteFile@nt@win32@fast_io@@YGIPAX0P6AX0PAUio_status_block@123@I@Z01PBXIPA_JPAI@Z=__imp__ZwWriteFile@36")
#pragma comment(linker,"/alternatename:__imp_?NtReadFile@nt@win32@fast_io@@YGIPAX0P6AX0PAUio_status_block@123@I@Z01PBXIPA_JPAI@Z=__imp__NtReadFile@36")
#pragma comment(linker,"/alternatename:__imp_?ZwReadFile@nt@win32@fast_io@@YGIPAX0P6AX0PAUio_status_block@123@I@Z01PBXIPA_JPAI@Z=__imp__ZwReadFile@36")
#pragma comment(linker,"/alternatename:__imp_?NtQueryDirectoryFile@nt@win32@fast_io@@YGIPAX0P6AX0PAUio_status_block@123@I@Z010IW4file_information_class@123@HPAUunicode_string@123@H@Z=__imp__NtQueryDirectoryFile@44")
#pragma comment(linker,"/alternatename:__imp_?ZwQueryDirectoryFile@nt@win32@fast_io@@YGIPAX0P6AX0PAUio_status_block@123@I@Z010IW4file_information_class@123@HPAUunicode_string@123@H@Z=__imp__ZwQueryDirectoryFile@44")
