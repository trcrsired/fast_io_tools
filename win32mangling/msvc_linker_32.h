...
#pragma comment(linker,"/alternatename:__imp_?_wgetenv_s@win32@fast_io@@YAHPAIPA_SIPB_S@Z=__imp__wgetenv_s")
#pragma comment(linker,"/alternatename:?_wgetenv_s@win32@fast_io@@YAHPAIPA_SIPB_S@Z=_wgetenv_s")
