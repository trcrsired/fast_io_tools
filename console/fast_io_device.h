...
template<std::integral char_type>
using basic_iobuf_console_file = std::conditional_t<
	std::same_as<typename native_console_file::char_type,char_type>,,
	basic_code_cvt_file<char_type,typename native_console_file::char_type>>;

template<std::integral char_type>
using basic_iobuf_console_file_mutex = basic_io_mutex<basic_iobuf_console_file<char_type>>;

using iobuf_console_file = basic_iobuf_console_file<char>;
using wiobuf_console_file = basic_iobuf_console_file<wchar_t>;
using u8iobuf_console_file = basic_iobuf_console_file<char8_t>;
using u16iobuf_console_file = basic_iobuf_console_file<char16_t>;
using u32iobuf_console_file = basic_iobuf_console_file<char32_t>;

using iobuf_console_file_mutex = basic_iobuf_console_file<char>;
using wiobuf_console_file_mutex = basic_iobuf_console_file<wchar_t>;
using u8iobuf_console_file_mutex = basic_iobuf_console_file<char8_t>;
using u16iobuf_console_file_mutex = basic_iobuf_console_file<char16_t>;
using u32iobuf_console_file_mutex = basic_iobuf_console_file<char32_t>;
