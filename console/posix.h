...
using native_console_file = u8posix_io_observer;

inline constexpr native_console_file native_console_stdin() noexcept
{
	return {0};
}

inline constexpr native_console_file native_console_stdout() noexcept
{
	return {1};
}

inline constexpr native_console_file native_console_stderr() noexcept
{
	return {2};
}
